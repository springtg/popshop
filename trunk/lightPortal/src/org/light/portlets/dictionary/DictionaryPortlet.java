 ...
 */
package org.light.portlets.dictionary;
 ...
 **/
public class DictionaryPortlet extends LightGenericPortlet {
    ...
    throws PortletException, java.io.IOException {		
	 ...
	 {	
        ...
        while (enumerator.hasMoreElements()){
            ...
            if(name.equals("Dictionary.com"))
            	searchEngine.add(0,new PortletPreference(name, portletPreferences.getValue(name,"")));
            else
		...
		this.getPortletContext().getRequestDispatcher(_PORTLET_JSP_PATH+"/dictionary/dictionaryPortletView.jsp").include(request,response);
	 }	
	 ...
	 {  		
		...
		request.setAttribute("searchEngine", searchEngine);
		this.getPortletContext().getRequestDispatcher(_PORTLET_JSP_PATH+"/dictionary/dictionaryPortletEdit.jsp").include(request,response);
	 }	
