...
public class AdPortlet extends LightGenericPortlet {
	 ...
	 public void processAction (ActionRequest request, ActionResponse response) 
	    throws PortletException, java.io.IOException {
			...
			if("save".equals(action)){
			   ...
			   if(adUrl != null) adUrl = URLDecoder.decode(adUrl,_CHARSET_UTF);
			   if(effDate != null) effDate = URLDecoder.decode(effDate,_CHARSET_UTF);
			   if(endEffDate != null) endEffDate = URLDecoder.decode(endEffDate,_CHARSET_UTF);
	 ...
	 {  
		...
		request.setAttribute("province",province);
		request.setAttribute("city",city);
		request.setAttribute("effDate",DateFormatter.format(effDate,"yyyy/MM/dd"));
		request.setAttribute("endEffDate",DateFormatter.format(endEffTime.getTime(),"yyyy/MM/dd"));
