...
public class MyBlurbPortlet extends LightGenericPortlet {
	   ...
	   throws PortletException, java.io.IOException
	 {
		 ...
		 request.setAttribute("userProfile",userProfile);
 		 this.getPortletContext().getRequestDispatcher(_PORTLET_JSP_PATH+"/profile/myBlurbPortletView.jsp").include(request,response);  
