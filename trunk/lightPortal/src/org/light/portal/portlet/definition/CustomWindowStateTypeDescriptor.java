...
public class CustomWindowStateTypeDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public CustomWindowStateTypeDescriptor() 
     {
        ...
        desc.setValidator(fieldValidator);
        //-- _windowState
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(org.light.portal.portlet.definition.WindowState.class, "_windowState", "window-state", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    CustomWindowStateType target = (CustomWindowStateType) object;
                    target.setWindowState( (org.light.portal.portlet.definition.WindowState) value);
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            ...
            public java.lang.Object newInstance( java.lang.Object parent ) {
                return new org.light.portal.portlet.definition.WindowState();
            }
        };
        desc.setHandler(handler);
        desc.setNameSpaceURI("http://java.sun.com/xml/ns/portlet/portlet-app_1_0.xsd");
        ...
        desc.setValidator(fieldValidator);
    } //-- org.light.portlet.definition.CustomWindowStateTypeDescriptor()
    ...
    {
        return org.light.portal.portlet.definition.CustomWindowStateType.class;
