...
public class UserDataConstraintTypeDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public UserDataConstraintTypeDescriptor() 
     {
        ...
        desc.setValidator(fieldValidator);
        //-- _transportGuarantee
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(org.light.portal.portlet.definition.types.TransportGuaranteeType.class, "_transportGuarantee", "transport-guarantee", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    UserDataConstraintType target = (UserDataConstraintType) object;
                    target.setTransportGuarantee( (org.light.portal.portlet.definition.types.TransportGuaranteeType) value);
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
        ...
        handler = new org.exolab.castor.xml.handlers.EnumFieldHandler(org.light.portal.portlet.definition.types.TransportGuaranteeType.class, handler);
        desc.setImmutable(true);
        desc.setHandler(handler);
        desc.setNameSpaceURI("http://java.sun.com/xml/ns/portlet/portlet-app_1_0.xsd");
        ...
        desc.setValidator(fieldValidator);
    } //-- org.light.portlet.definition.UserDataConstraintTypeDescriptor()
    ...
    {
        return org.light.portal.portlet.definition.UserDataConstraintType.class;
