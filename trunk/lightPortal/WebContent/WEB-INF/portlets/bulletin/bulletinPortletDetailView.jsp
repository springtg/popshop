...
<c:if test='${requestScope.bulletin.photoUrl != null}'>
<img src='<%= request.getContextPath() %><c:out value="${requestScope.bulletin.photoUrl}"/>' style='border: 0px;'  align="middle" width='<c:out value="${requestScope.bulletin.photoWidth}"/>' height='<c:out value="${requestScope.bulletin.photoHeight}"/>'/>
</c:if>
<br/>
