...
<form name='myFileForm' enctype='multipart/form-data' method='post' accept-charset='UTF-8' 
  action ='<%= request.getContextPath() %>/uploadFile.lp' onsubmit="javascript:return AIM.submit(this, {'onStart' : startCallback, 'onComplete' : completeCallback}, '<c:out value="${requestScope.responseId}"/>')">
  <table border='0' cellpadding='0' cellspacing='0' >
    <tr>
      <td class='portlet-table-td-left' >
        Upload File :
