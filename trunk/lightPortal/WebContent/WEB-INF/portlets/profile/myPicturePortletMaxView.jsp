...
<tr>
<td class='portlet-link-left' >
<fmt:message key="portlet.label.youHave"/> <c:out value="${requestScope.pictureCount}"/> <fmt:message key="portlet.label.pictures"/>
</td>
</tr>
</table>
<light:authenticateUser> 
<div onmouseover="javascript:document.getElementById('myPictureButton0').style.visibility = 'visible';document.getElementById('myPictureButton1').style.visibility = 'visible';getElementById('myPictureButton2').style.visibility = 'visible';getElementById('myPictureButton3').style.visibility = 'visible';getElementById('myPictureButton4').style.visibility = 'visible';getElementById('myPictureButton5').style.visibility = 'visible';getElementById('myPictureButton6').style.visibility = 'visible';"
	   onmouseout="javascript:getElementById('myPictureButton0').style.visibility = 'hidden';getElementById('myPictureButton1').style.visibility = 'hidden';getElementById('myPictureButton2').style.visibility = 'hidden';getElementById('myPictureButton3').style.visibility = 'hidden';getElementById('myPictureButton4').style.visibility = 'hidden';getElementById('myPictureButton5').style.visibility = 'hidden';getElementById('myPictureButton6').style.visibility = 'hidden';">
<table border='0' cellpadding='0' cellspacing='0' width= '100%' >
...
<a id ='myPictureLink2' href='javascript:void(0)' onclick="javascript:stopSlideShow('<c:out value="${requestScope.responseId}"/>');"><image title='<fmt:message key="portlet.label.stopSlideShow"/>' src="<%= request.getContextPath() %>/light/images/stop.gif" style='border: 0px;' height='16' width='16' align='middle' /></a> 
<a id ='myPictureLink3' href='javascript:void(0)' onclick="javascript:startSlideShow('<c:out value="${requestScope.responseId}"/>',<c:out value="${requestScope.pictureCount}"/>);"><image title='<fmt:message key="portlet.label.startSlideShow"/>' src="<%= request.getContextPath() %>/light/images/play.gif" style='border: 0px;' height='16' width='16' align='middle' /></a> 
...
<a href='javascript:void(0)' onclick="javascript:startAllSlideShow('<c:out value="${requestScope.responseId}"/>',<c:out value="${requestScope.pictureCount}"/>);" ><fmt:message key="portlet.label.all"/>(<c:out value="${requestScope.pictureCount}"/>)</a>
</td>
</tr>
<c:forEach var="date" items="${requestScope.datePictures}" varStatus="status">
<tr class='portlet-table-td-left'>
<td class='portlet-item'>
<a href='javascript:void(0)' onclick="javascript:startGroupSlideShow('<c:out value="${requestScope.responseId}"/>','date_<c:out value="${status.index}"/>',<c:out value="${date.count}"/>);" ><c:out value="${date.name}"/>(<c:out value="${date.count}"/>)</a>
</td>
</tr>
</c:forEach>
</table>
...
<img id='currentMyPicture_<c:out value="${requestScope.responseId}"/>' src='<c:out value="${currentPictureUrl}"/>' class='portlet'  align="middle" width='<c:out value="${currentPictureWidth}"/>' height='<c:out value="${currentPictureHeight}"/>'/>
<br/>
...
<tr class='portlet-table-td-left'>
<td class='portlet-item'>
<a href='javascript:void(0)' onclick="javascript:startGroupSlideShow('<c:out value="${requestScope.responseId}"/>','tag_<c:out value="${status.index}"/>',<c:out value="${tag.count}"/>);" ><c:out value="${tag.name}"/>(<c:out value="${tag.count}"/>)</a>
</td>
</tr>
</c:forEach>
</table>
...
<c:if test='${picture.httpUrl}'>
<input type='hidden' id='pictures_<c:out value="${status.index}"/>' name='<c:out value="${picture.id}"/>;<c:out value="${picture.largeWidth}"/>;<c:out value="${picture.largeHeight}"/>;<c:out value="${picture.pictureUrl}"/>;<c:out value="${picture.status}"/>;<c:out value="${picture.tag}"/>' value='<c:out value="${picture.caption}"/>'/>
</c:if>
<c:if test='${!picture.httpUrl}'>
<input type='hidden' id='pictures_<c:out value="${status.index}"/>' name='<c:out value="${picture.id}"/>;<c:out value="${picture.largeWidth}"/>;<c:out value="${picture.largeHeight}"/>;<%= request.getContextPath() %><c:out value="${picture.pictureUrl}"/>;<c:out value="${picture.status}"/>;<c:out value="${picture.tag}"/>' value='<c:out value="${picture.caption}"/>'/>
</c:if>
</c:forEach>
</div>
...
<c:if test='${picture.httpUrl}'>
<input type='hidden' id='date_<c:out value="${status1.index}"/>_<c:out value="${status2.index}"/>' name='<c:out value="${picture.id}"/>;<c:out value="${picture.largeWidth}"/>;<c:out value="${picture.largeHeight}"/>;<c:out value="${picture.pictureUrl}"/>;<c:out value="${picture.status}"/>;<c:out value="${picture.tag}"/>' value='<c:out value="${picture.caption}"/>'/>
</c:if>
<c:if test='${!picture.httpUrl}'>
<input type='hidden' id='date_<c:out value="${status1.index}"/>_<c:out value="${status2.index}"/>' name='<c:out value="${picture.id}"/>;<c:out value="${picture.largeWidth}"/>;<c:out value="${picture.largeHeight}"/>;<%= request.getContextPath() %><c:out value="${picture.pictureUrl}"/>;<c:out value="${picture.status}"/>;<c:out value="${picture.tag}"/>' value='<c:out value="${picture.caption}"/>'/>
</c:if>
</c:forEach>
</div>
</c:forEach>
...
<c:if test='${picture.httpUrl}'>
<input type='hidden' id='tag_<c:out value="${status1.index}"/>_<c:out value="${status2.index}"/>' name='<c:out value="${picture.id}"/>;<c:out value="${picture.largeWidth}"/>;<c:out value="${picture.largeHeight}"/>;<c:out value="${picture.pictureUrl}"/>;<c:out value="${picture.status}"/>;<c:out value="${picture.tag}"/>' value='<c:out value="${picture.caption}"/>'/>
</c:if>
<c:if test='${!picture.httpUrl}'>
<input type='hidden' id='tag_<c:out value="${status1.index}"/>_<c:out value="${status2.index}"/>' name='<c:out value="${picture.id}"/>;<c:out value="${picture.largeWidth}"/>;<c:out value="${picture.largeHeight}"/>;<%= request.getContextPath() %><c:out value="${picture.pictureUrl}"/>;<c:out value="${picture.status}"/>;<c:out value="${picture.tag}"/>' value='<c:out value="${picture.caption}"/>'/>
</c:if>
</c:forEach>
</div>
</c:forEach>
