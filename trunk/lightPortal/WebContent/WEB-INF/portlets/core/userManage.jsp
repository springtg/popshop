...
<a href='javascript:void(0)' onclick="<portlet:renderURL  portletMode='EDIT' windowState='MAXIMIZED'/>" ><img src='<%= request.getContextPath() %>/light/images/add.gif' style='border: 0px;' height='16' width='16' align="middle"/><fmt:message key="portlet.label.addUser"/></a>
</td>
</tr>
</table>
...
<a href='http://www.<c:out value="${sessionScope.org.space}"/><c:out value="${searchedUser.uri}"/>' target='_blank'>http://www.<c:out value="${sessionScope.org.space}"/><c:out value="${searchedUser.uri}"/></a>
</span>
</td>
</tr>
<tr>
