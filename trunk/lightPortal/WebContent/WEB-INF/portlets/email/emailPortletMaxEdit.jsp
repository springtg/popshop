...
<input type='text' name='toEmail'  value='<c:out value="${requestScope.toEmail}"/>' class='portlet-form-input-field' size='100' /> 
</td>
</tr>
<tr>
<td class='portlet-table-td-left' width='80'>
...
<td class='portlet-table-td-left'>
<input type='text' name='cc'  value='<c:out value="${requestScope.cc}"/>' class='portlet-form-input-field' size='100' /> 
</td>
</tr>
<tr>
<td class='portlet-table-td-left' width='80' >
...
<td class='portlet-table-td-left'>
<input type='text' name='bcc'  value='<c:out value="${requestScope.bcc}"/>' class='portlet-form-input-field' size='100' /> 
</td>
</tr>
<tr>
<td class='portlet-table-td-left' width='80'>
...
<td class='portlet-table-td-left'>
<input type='text' name='subject'  value='<c:out value="${requestScope.subject}"/>' class='portlet-form-input-field' size='100' /> 
</td>
</tr>
<tr>
...
<td class='portlet-table-td-left' colspan='2'>
<c:if test='${showHtmlEditor == null}'>
<textarea name='content' class='portlet-form-textarea-field' rows='5' cols='130' >
