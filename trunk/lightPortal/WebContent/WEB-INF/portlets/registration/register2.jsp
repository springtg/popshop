...
<td class='portlet-table-td-left'>
<input TYPE='radio' name='gender' value='male' checked="checked"><fmt:message key="portlet.label.gender.male"/></input>
<input TYPE='radio' name='gender' value='female'><fmt:message key="portlet.label.gender.female"/></input>
</td>
</tr>
<tr>
