...
var height=parseInt(portal.headerHeight);if(height>0)vPortalHeader.style.height=60+parseInt(height);var userId=Light.getCookie(Light._LOGINED_USER_ID);if(userId==null||userId=="")
userId=Light.getCookie(Light._USER_ID);if(userId!=null&&userId!=""){var vTitle=document.createElement('span');vTitle.id="portal-header-title";vTitle.className="portal-header-title";if(portal.title.trim().length==0){vTitle.innerHTML="<input type='text' id='portalTitle' class='portal-header-title-edit' value='' onchange=\"javascript:Light.portal.saveTitle();\" onblur=\"javascript:Light.portal.saveTitle();\"/>";}else{vTitle.innerHTML="<span class='portal-header-title-view' onmousemove=\"javascript:if(this.className=='portal-header-title-view'){this.style.backgroundColor ='#EEF6FF';}\" onmouseout=\"javascript:if(this.className=='portal-header-title-view'){Light.portal.viewTitle(this);}\"  onmousedown=\"javascript:if(this.className=='portal-header-title-view'){this.className='portal-header-title-edit'; Light.portal.editTitle(this);}\">"+Light.portal.title+"</span>";}
vPortalHeader.appendChild(vTitle);}else{vPortalHeader.style.height=60;}
var vLogo=document.createElement('span');vLogo.className="portal-header-logo";var logo=Light.portal.logo;if(!logo.startsWith("http"))logo=portal.contextPath+logo;var strLogo="<a href='javascript:void(0)' onclick='javascript:window.location.reload(true);'><img src='"+logo+"' style='border: 0px;'/></a>";vLogo.innerHTML=strLogo;if(document.all){vLogo.style.posLeft=Light.portal.layout.containerLeft;}
...
LightPortalMenuImpl.prototype.render=function(portal){tab=Light.currentTab;var vBody=document.createElement('div');vBody.id="portalMenu";vBody.className="portal-header-menu";if(portal.showSearchBar){var vSearch=document.createElement('span');vSearch.className="portal-header-search";vSearch.innerHTML=Light.getViewTemplate("searchBar.view",null);vBody.appendChild(vSearch);}
var noMenu=true;var vSpan=document.createElement('span');vSpan.className="portal-header-menu-item";if(portal.allowLookAndFeel){var varA=document.createElement('a');varA.innerHTML=$('_MENU_LOOK_AND_FEEL').title;varA.href="javascript:void(0)";varA.onclick=function(){Light.changeOptions();}
vSpan.appendChild(varA);var vLine1=document.createElement('span');vLine1.className="portal-header-menu-item-separater";vSpan.appendChild(vLine1);noMenu=false;}
...
vSpan.appendChild(varB);var vLine2=document.createElement('span');vLine2.className="portal-header-menu-item-separater";vSpan.appendChild(vLine2);noMenu=false;}
...
vSpan.appendChild(varD);var vLine4=document.createElement('span');vLine4.className="portal-header-menu-item-separater";vSpan.appendChild(vLine4);noMenu=false;}
if(portal.allowSignIn){var varE=document.createElement('a');var u=Light.getCookie(Light._LOGINED_USER_ID);if(Light.getCookie(Light._LOGINED_USER_ID)!=null&&Light.getCookie(Light._LOGINED_USER_ID)!=""){varE.innerHTML=$('_MENU_SIGN_OUT').title;varE.href="javascript:void(0)";varE.onclick=function(){Light.logout();}}else{varE.innerHTML=$('_MENU_SIGN_IN').title;varE.href="javascript:void(0)";varE.onclick=function(){Light.loginToMyAccount();}}
vSpan.appendChild(varE);var vLine5=document.createElement('span');vLine5.className="portal-header-menu-item-separater";vSpan.appendChild(vLine5);noMenu=false;}
if(portal.allowSignIn&&Light.getCookie(Light._LOGINED_USER_ID)!=null&&Light.getCookie(Light._LOGINED_USER_ID)!=""){var varE=document.createElement('a');varE.innerHTML=$('_MENU_MY_PROFILE').title;varE.href="javascript:void(0)";varE.onclick=function(){Light.editProfile();}
vSpan.appendChild(varE);var vLine5=document.createElement('span');vLine5.className="portal-header-menu-item-separater";vSpan.appendChild(vLine5);noMenu=false;}
var userId=Light.getCookie(Light._LOGINED_USER_ID);if(userId==null||userId=="")
userId=Light.getCookie(Light._USER_ID);if(userId!=null&&userId!=""){if(noMenu){var varF=document.createElement('a');varF.innerHTML=$('_MENU_MY_ACCOUNT').title;varF.href="javascript:void(0)";varF.onclick=function(){Light.toMyAccount();}
vSpan.appendChild(varF);var vLine6=document.createElement('span');vLine6.className="portal-header-menu-item-separater";vSpan.appendChild(vLine6);}
var varUp=document.createElement('a');varUp.innerHTML="<img src='"+portal.contextPath+"/light/images/collapseAll.gif' style='border: 0px' height='12' width='12' align='top' title='"+$('_MENU_COLLAPSE_ALL').title+"'/>";varUp.href="javascript:void(0)";varUp.onclick=function(){Light.portal.collapseAll();}
