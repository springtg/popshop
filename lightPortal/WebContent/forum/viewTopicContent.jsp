...
<b><c:out value="${categoryName}"/>-><c:out value="${forumName}"/>-><c:out value="${topicName}"/></b>
</td>
<td class='portlet-link' >
<a href='viewforum.do?id=<c:out value="${forumId}"/>p1'>
...
<a href='viewtopic.do?id=<c:out value="${topicId}"/>p<c:out value="${i}"/>' ><c:out value="${i}"/></a>
</c:forEach>
</c:if>
</td>
</tr>
