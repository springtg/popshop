...
<b><c:out value="${groupName}"/></b>
</td>
<td class='portlet-link' >
<a href='viewgroups.do'>
...
<a href='groupforum.do?id=<c:out value="${groupId}"/>p<c:out value="${i}"/>' ><c:out value="${i}"/></a>
</c:forEach>
</c:if>
</td>
</tr>
...
<a href='grouptopic.do?id=<c:out value="${forum.id}"/>p1'>
