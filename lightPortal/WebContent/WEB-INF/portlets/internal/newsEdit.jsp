...
<input type='text' name='subject' value='<c:out value="${requestScope.subject}"/>' class='portlet-form-input-field' size='40' /> 
<input type='hidden' name='newsId' value='<c:out value="${requestScope.newsId}"/>'/>
</td>
</tr>
<tr>
...
<td class='portlet-table-td-left' colspan='2'>
<c:if test='${showHtmlEditor == null}'>
<textarea name='content' class='portlet-form-textarea-field' rows='5' cols='40' ><c:if test='${requestScope.content != null}'><c:out value="${content}" /></c:if></textarea>
</c:if>
<c:if test='${showHtmlEditor != null}'>
