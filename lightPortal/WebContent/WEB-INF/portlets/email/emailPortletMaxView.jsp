...
<a href='javascript:void(0)' onclick="javascript:Light.executeRender('<c:out value="${requestScope.responseId}"/>','','','mailId=<c:out value="${status.index}"/>;pageId=<c:out value="${pageId}"/>');"><c:out value="${mail.fromName}"/></a>
<c:if test='${mail.flag == 1}'>
</b>
</c:if>
</td>
...
<a href='javascript:void(0)' onclick="javascript:Light.executeRender('<c:out value="${requestScope.responseId}"/>','','','mailId=<c:out value="${status.index}"/>;pageId=<c:out value="${pageId}"/>');"><c:out value="${mail.subject}"/></a>
<c:if test='${mail.flag == 1}'>
</b>
</c:if>
</td>
