...
<fmt:message key="portlet.label.forumSubCategory"/>:
</td>
<td class='portlet-table-td-left'  >
<input type='text' name='subCategory'  value='<c:out value='${requestScope.subCategory}'/>' class='portlet-form-input-field' size='50' /> 
</td>
</tr>
<tr>
<td class='portlet-table-td-right' width='100'>
...
<td class='portlet-table-td-left'  >
<input type='text' name='subCategoryDesc'  value='<c:out value='${requestScope.subCategoryDesc}'/>' class='portlet-form-input-field' size='50' /> 
</td>
</tr>
<tr>
