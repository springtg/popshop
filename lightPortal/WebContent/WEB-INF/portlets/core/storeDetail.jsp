...
<tr>
<td class='portlet-table-td-left' colspan='2'>
<textarea name='view' class='portlet-form-textarea-field' rows='5' cols='60' ></textarea>
</td>
</tr>
<tr>
<td class='portlet-table-td-left' colspan='2'>
...
<tr>
<td class='portlet-table-td-left' colspan='2'>
<textarea name='maxView' class='portlet-form-textarea-field' rows='5' cols='60' ></textarea>
</td>
</tr>

<tr valign='top'>
<td class='portlet-table-td-right' colspan ='2'>
<input type='submit' name='action' onClick="document.pressed='addStore'" value='<fmt:message key="portlet.button.add"/>' class='portlet-form-button' />
...
<table border='0' cellpadding='0' cellspacing='0' width="100%">
<tr>
<td class="portlet-table-td-right" width="15%"></td>
<td class="portlet-table-td-left">
<c:forEach var="tab" items="${requestScope.tabs}" >
<span class="portlet-rss" > 
<a href='page/<c:out value="${tab.id}" />?orgId=<c:out value="${org.id}"/>' target='_blank'>Default Page Link</a>
</span>
</c:forEach>
</td>
</tr>
...
<tr>
<td class='portlet-table-td-right' colspan ='2'>
<input type='submit' name='action' onClick="document.pressed='modifyStore'" value='<fmt:message key="portlet.button.save"/>' class='portlet-form-button' />
<input type='button' name='action' onClick="javascript:Light.executeRender('<c:out value="${requestScope.responseId}"/>','view','normal','');" value='<fmt:message key="portlet.button.cancel"/>' class='portlet-form-button' />
</td>
</tr>
</table>
