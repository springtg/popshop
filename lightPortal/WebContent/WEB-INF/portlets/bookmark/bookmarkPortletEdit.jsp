...
<td class='portlet-table-td-left'>
<input type='text' name='url' class='portlet-form-input-field' size='40' />
</td>
</tr>
<tr>
<td class='portlet-table-td-left'>
...
<td class='portlet-table-td-left'>
<input type='text' name='name' class='portlet-form-input-field' size='40'/>
</td>
</tr>
<tr>
<td class='portlet-table-td-left'>
...
<td class='portlet-table-td-left'>
<input type='text' name='desc' class='portlet-form-input-field' size='40'/>
</td>
</tr>
<tr>
<td class='portlet-table-td-left'>
...
<td class='portlet-table-td-left'>
<input type='text' name='url' class='portlet-form-input-field' size='40' value='<c:out value="${bookmark.url}"/>' />
</td>
</tr>
<tr>
<td class='portlet-table-td-left'>
...
<td class='portlet-table-td-left'>
<input type='text' name='name' class='portlet-form-input-field' size='40' value='<c:out value="${bookmark.name}"/>'/>
</td>
</tr>
<tr>
<td class='portlet-table-td-left'>
...
<td class='portlet-table-td-left'>
<input type='text' name='desc' class='portlet-form-input-field' size='40' value='<c:out value="${bookmark.desc}"/>'/>
</td>
</tr>
<tr>
<td class='portlet-table-td-left'>
...
<input type='text' name='tag' class='portlet-form-input-field' size='40' value='<c:out value="${bookmark.tagNameValue}"/>'/>
</td>
</tr>
<tr>
<td class='portlet-table-td-right' colspan ='2'>
