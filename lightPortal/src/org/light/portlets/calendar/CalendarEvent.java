...
public class CalendarEvent extends Entity{
	...
	public CalendarEvent(Date startDate, int startTime, Date endDate, int endTime, long userId, int state){
		this();
		this.userId = userId;
	...
	public CalendarEvent(String name,String location,String desc,Date startDate, int startTime, Date endDate, int endTime, long userId, int state){
		this();
		this.name =name;
	...
	public CalendarEvent(String name,String location,String desc,Date startDate, int startTime, Date endDate, int endTime, long userId, int state, long parentId){
		this();
		this.name =name;
		this.location = location;
		this.desc =desc;
	...
	public CalendarEvent(String name,String location,String desc, String link,Date startDate, int startTime, Date endDate, int endTime, long userId, int state){
		this();
		this.name =name;
		this.location = location;
		this.desc =desc;
