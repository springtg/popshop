...
public class BlogSearcher implements org.light.portal.search.Searcher{
	...
	public SearchResult search(SearchCriteria criteria) throws Exception { 
		...
		try {
			...
			Query query1 = new QueryParser(Indexer._TYPE_ID,analyer).parse(BlogIndexer._TYPE_VALUE);			
