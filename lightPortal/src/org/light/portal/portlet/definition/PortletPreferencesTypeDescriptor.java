...
public class PortletPreferencesTypeDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public PortletPreferencesTypeDescriptor() 
     {
        ...
        //-- _preferenceList
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(org.light.portal.portlet.definition.Preference.class, "_preferenceList", "preference", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    PortletPreferencesType target = (PortletPreferencesType) object;
                    target.addPreference( (org.light.portal.portlet.definition.Preference) value);
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            ...
            public java.lang.Object newInstance( java.lang.Object parent ) {
                return new org.light.portal.portlet.definition.Preference();
            }
        };
        desc.setHandler(handler);
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    PortletPreferencesType target = (PortletPreferencesType) object;
                    target.setPreferencesValidator( (java.lang.String) value);
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
        ...
        desc.setValidator(fieldValidator);
    } //-- org.light.portlet.definition.PortletPreferencesTypeDescriptor()
    ...
    {
        return org.light.portal.portlet.definition.PortletPreferencesType.class;
