...
<div id="filter">
 	...
 	公司名称: <input type="text" name="filter_LIKE_companyName" value="${param['filter_LIKE_companyName']}" size="9"/>
...
<table>
	<tr>
		...
		<th><a href="javascript:sort('companyName','asc')""><b>公司名称</b></a></th>
		<th><a href="javascript:sort('mark','asc')"><b>备注</b></a></th>		
		<th><b>操作</b></th>
	</tr>
		...
		<tr>
			...
			<td>&nbsp; 
				<security:authorize ifAnyGranted="A_MODIFY_USER">
					<a href="company!input.action?id=${id}">修改</a>、
					<a href="company!delete.action?id=${id}">删除</a>
				</security:authorize>
			</td>
		</tr>
	</s:iterator>
...
<div id="footer">
	...
	<security:authorize ifAnyGranted="A_MODIFY_USER">
		<a href="company!input.action">增加新公司资料</a>
	</security:authorize>
</div>
</form>
</body>
